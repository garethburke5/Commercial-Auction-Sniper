...
# Compact utility strip: primary action + target yield only. Theme and all
...
lots_tab,sources_tab=st.tabs(["🎯 Current properties","📡 Source health"])
...
with lots_tab:
    ...
    # Pagination belongs at the filtered data-list layer. Never intercept or
