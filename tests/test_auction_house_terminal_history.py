...
class AuctionHouseTerminalHistoryTests(unittest.TestCase):
    ...
    def test_explicit_auction_house_categories_include_hospitality_and_heavy_industrial(self):
    ...
    def test_current_sale_sold_prior_commercial_is_emitted_as_history(self):
        event_html = '''
        <html><body>
          <article>
